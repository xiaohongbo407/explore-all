...
//        final String transform = "DES/ECB/PKCS5Padding";
        ...
        System.out.println("encoded BASE64Encoder : "+new BASE64Encoder().encode(encoded));
        System.out.println("encoded byte : "+Arrays.toString(encoded));
